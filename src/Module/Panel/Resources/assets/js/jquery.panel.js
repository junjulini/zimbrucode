...
var Condition = /*#__PURE__*/function (_Kernel) {
  ...
  _createClass(Condition, [{
    ...
    value: function onChange() {
      ...
      $('.zc-panel .zc-panel-controls [data-control=condition]').on('change', '[data-control=option]:not([data-i="i"])', function (event) {
