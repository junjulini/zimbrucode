...
zc.module.panel.addMode(function ($, panel) {
  setTimeout(function () {
    ...
    var oh = new _module_header_option_handler__WEBPACK_IMPORTED_MODULE_1__["default"](); // Save/Reset => .

    new _module_header_quick_links__WEBPACK_IMPORTED_MODULE_2__["default"](); // Initialization of panel button "Quick Links".

    panel.addCache('option-handler', oh); // Active section
