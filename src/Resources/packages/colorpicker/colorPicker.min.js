...
// ZC Color Picker v1.0.0
!function(k,t){k.fn.extend({zcColorPicker:function(a){var s=this,u={renderCallback:function(o,e){var r=this,i=k(r.input),t=o.RND.rgb,c=o.RND.hsl,n=r.isIE8?(o.alpha<.16?"0":"")+Math.round(100*o.alpha).toString(16).toUpperCase()+o.HEX:"",a=t.r+", "+t.g+", "+t.b,s="rgba("+a+", "+o.alpha+")",l=1!==o.alpha&&!r.isIE8,d=i.data("colorMode"),p="";p="HEX"!==d||l?"rgb"===d||"HEX"===d&&l?l?s:"rgb("+a+")":"hsl"+(l?"a(":"(")+c.h+", "+c.s+"%, "+c.l+"%"+(l?", "+o.alpha:"")+")":"#"+(r.isIE8?n:o.HEX),k.isFunction(r.renderEC)&&r.renderEC(o,e,r,p)},extractValue:function(o){return k(o).val()||k(o).data("colorpicker-value")||"#FFFFFF"},actionCallback:function(o,e){var r=this,i=h.current;if(k.isFunction(r.actionEC)&&r.actionEC(e),"toMemery"===e){for(var t,c=i.nodes.memos,n="",a=0,s=[],l=0,d=c.length;l<d;l++)n=(t=k(c[l])).css("background-color"),a=Math.round(100*t.css("opacity"))/100,s.push(n.replace(/, /g,",").replace("rgb(","rgba(").replace(")",","+a+")"));s="'"+s.join("','")+"'",u.docCookies("colorPickerMemos"+(r.noAlpha?"NoAlpha":""),s)}else if("resizeApp"===e)u.docCookies("colorPickerSize",i.color.options.currentSize);else if("modeChange"===e){var p=i.color.options.mode;u.docCookies("colorPickerMode",p.type+"-"+p.z)}},createInstance:function(o,e){var r={klass:t.ColorPicker,input:o,patch:o,isIE8:!!document.all&&!document.addEventListener,animationSpeed:200,draggable:!0,margin:{left:1,top:40},customBG:"#FFFFFF",color:u.extractValue(o),initStyle:"display: none",mode:u.docCookies("colorPickerMode")||"hsv-h",memoryColors:u.docCookies("colorPickerMemos"+((e||{}).noAlpha?"NoAlpha":"")),size:u.docCookies("colorPickerSize")||1,renderCallback:u.renderCallback,actionCallback:u.actionCallback};for(var i in e)r[i]=e[i];return new r.klass(r)},doEventListeners:function(c,n){k(c).on("click.colorPicker",function(o){o.preventDefault();k(this).offset();var e=n?k("[data-colorpicker=colorpicker]").index(this):0,r=h[e]=u.createInstance(this,a),i=r.color.options;if(k.ui&&i.draggable)var t=k(r.nodes.colorPicker).draggable({cancel:"."+i.CSSPrefix+"app div"});else t=k(r.nodes.colorPicker);i.color=u.extractValue(c),t.css({position:"absolute",left:i.margin.left,top:i.margin.top}),i.eventListenersCallback&&i.eventListenersCallback(c,t,i),n||(i.input=c,i.patch=c,r.setColor(u.extractValue(c),void 0,void 0,!0),r.saveAsBackground()),h.current=h[e],k(this).parent().append(t),setTimeout(function(){t.show(r.color.options.animationSpeed)},0)}),k(t).on("mousedown.colorPicker",function(o){var e=h.current,r=k(e?e.nodes.colorPicker:void 0),i=e?e.color.options.animationSpeed:0,t=k(o.target).closest(".cp-app")[0];k(s).index(o.target);t&&e&&k(h).index(t)?o.target===e.nodes.exit&&(r.hide(i),k(":focus").trigger("blur"),r.remove()):(r.hide(i),r.remove(),void 0!==e&&(k(e.color.options.input).change(),delete h.current))})},docCookies:function(o,e,r){var i,t,c,n,a=encodeURIComponent,s=decodeURIComponent,l={};if(void 0===e){for(t=(i=document.cookie.split("; ")||[]).length;t--;)(c=i[t].split("="))[0]&&(l[s(c.shift())]=s(c.join("=")));return o?l[o]:l}r=r||{},(""===e||r.expires<0)&&(r.expires=-1),void 0!==r.expires&&(n=new Date).setDate(n.getDate()+r.expires),document.cookie=a(o)+"="+a(e)+(n?"; expires="+n.toUTCString():"")+(r.path?"; path="+r.path:"")+(r.domain?"; domain="+r.domain:"")+(r.secure?"; secure":"")}},h=k.fn.zcColorPicker.colorPickers||[],r=new t.Colors({customBG:a&&a.customBG||"#FFFFFF",allMixDetails:!0});if(k.fn.zcColorPicker.colorPickers=h,k(this).off(".colorPicker"),k(t).off(".colorPicker"),"destroy"!==a){var o=u.extractValue(this),e=o.split("("),i=e[1]?e[0].substr(0,3):"HEX";k(this).data("colorMode",i),u.doEventListeners(this,a&&a.multipleInstances),k(this).on("paste keyup",function(){var o=k(this).val(),e=k("[data-colorpicker=colorpicker]").index(this);o&&(r.setColor(o),isNaN(r.getColor().RGBLuminance)||(k(this).parent().find(".zc-panel-control-colorpicker__live-color").css("background",o),void 0!==h[e]&&h[e].setColor(o)))}),a&&a.readOnly&&(this.readOnly=!0),r.setColor(o),a&&a.init&&a.init(this,r.colors)}return this}})}(jQuery,this);