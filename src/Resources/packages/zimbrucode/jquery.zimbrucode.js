...
var ZimbruCode = /*#__PURE__*/function () {
  ...
  _createClass(ZimbruCode, [{
    key: "setModule",
    value: function setModule(name, module) {
    ...
    key: "setModuleData",
    value: function setModuleData(name) {
