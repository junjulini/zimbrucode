...
use ZimbruCode\Component\Asset\Library\Less\Visitor\ExtendFinder;
...
class Selector extends Tree
{
    ...
    public function accept($visitor)
    {
        ...
        if ($visitor instanceof ExtendFinder) {
            $this->CacheElements();
        }
    }
    ...
    {
        $newSelector                 = new Selector($elements, ($extendList ? $extendList : $this->extendList), null, $this->index, $this->currentFileInfo, $this->isReferenced);
    ...
    public function isJustParentSelector()
    {
        ...
        $this->elements[0]->value === '&' && ($this->elements[0]->combinator === ' ' || $this->elements[0]->combinator === '');
    }
