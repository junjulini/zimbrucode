...
/**
 * Class : Process Extends Visitor
 *
 * @author  Junjulini
 * @package ZimbruCode
 * @since   ZimbruCode 1.0.0
 */
class ProcessExtends extends Visitor
{
    public $allExtendsStack;

    public function run($root)
    {
        $extendFinder = new ExtendFinder();
    ...
    private function doExtendChaining($extendsList, $extendsListTarget, $iterationCount = 0)
    {
        ...
        if ($extendsToAdd) {
            ...
            if ($iterationCount > 100) {
                ...
                throw new ExceptionParser("extend circular reference detected. One of the circular extends is currently:" . $selectorOne . ":extend(" . $selectorTwo . ")");
            }
    ...
    private function isElementValuesEqual($elementValue1, $elementValue2)
    {
        ...
        if ($elementValue1 instanceof Selector) {
    ...
    private function isSelectorValuesEqual($elementValue1, $elementValue2)
    {
        ...
        if (!($elementValue2 instanceof Selector) || $elementValue1->elements_len !== $elementValue2->elements_len) {
            return false;
        }
